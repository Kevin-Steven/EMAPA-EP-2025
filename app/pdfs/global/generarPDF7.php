...
$fecha_inicio_larga = $_POST['fecha_inicio'] ? formato_fecha_larga($_POST['fecha_inicio']) : 'NO APLICA';
...
$html_parrafo_17 = '<table width="100%" border="0" cellspacing="0" cellpadding="1">
    <tr>
