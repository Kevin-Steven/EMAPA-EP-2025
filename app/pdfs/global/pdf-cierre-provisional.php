...
$deuda_inquilinos = isset($_POST['deuda_inquilinos']) ? '✔' : '';
$casa_deshabitada = isset($_POST['casa_deshabitada']) ? '✔' : '';
$terreno_vacio = isset($_POST['terreno_vacio']) ? '✔' : '';
...
$pdf->SetY(25);
$pdf->Cell(0, 10, 'SOLICITUD DE CIERRE PROVISIONAL', 0, 1, 'C');
...
$pdf->SetXY(15, $y);
$pdf->SetFont('helvetica', 'B', 11);
$pdf->Cell(0, 7, 'ESPECIFIQUE EL MOTIVO DEL CIERRE PROVISIONAL :', 0, 1);
...
$pdf->SetXY(15, $y);
$pdf->SetFont('helvetica', 'B', 11);
$pdf->Cell(0, 7, 'MOTIVOS DEL CIERRE PROVISIONAL', 0, 1);
$y += 10;
$pdf->SetFont('dejavusans', '', 10);

$motivos = [
    'DEUDA DE INQUILINOS' => $deuda_inquilinos,
    'CASA DESHABITADA' => $casa_deshabitada,
    'TERRENO VACÍO' => $terreno_vacio,
    'OTROS' => $otros
];
...
$pdf->Output("Solicitud_Cierre_Provisional.pdf", 'I');
exit();
